...
* Request
  * Method: PATCH
  * Route path: /api/reviews/:id/edit
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * Route path: /api/:userId/bookings
  * Body: none
...
* Request
  * Method: PUT
  * Route path: /api/bookings/:id/edit
  * Headers:
    * Content-Type: application/json
  * Body:
